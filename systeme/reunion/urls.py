...
urlpatterns = [
    ...
    path('meeting_attachments/<int:fiche_id>/', get_piece_jointe_meet, name='piece_jointe'),
    ...
    path('create_Decision/<int:pk>/', CreateDecisionAPIView.as_view(), name='create_Decision'),
