...
class AddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = Address
        fields = ['address_name','Street','City','State','Zip_code']
...
class PosteFonctionSerializer(serializers.ModelSerializer):
    class Meta :
        model = PosteFonction
        fields = ['intitule_fonction','positionnement','mission_principale','relation_fonctionnelle','competences_requises','activite_principale']