            ...
            <div class="container ajout-form">
                <div class="contact-image ">
                    ...
                    <div class="button-container">
                        ...
                        </Link>   <button className="button-add" type="submit">Modifier une fiche</button>
                    </div>
                </div>
                <form onSubmit={handleSubmit} className="row">
                    <div className="col-md-6">
                        ...
                        <div className="form-label">
                            ...
                            <input type="text" className="form-control" value={work_mobile} onChange={(e) => setWorkMobile(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Téléphone :</label>
                            <input type="text" className="form-control" value={work_phone} onChange={(e) => setWorkPhone(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Email :</label>
                            <input type="email" className="form-control" value={work_email} onChange={(e) => setWorkEmail(e.target.value)} />
                        </div>
                        <div className="form-label">
                        ...
                        <div className="form-label">
                            ...
                            <input type="text" className="form-control" value={work_location} onChange={(e) => setWorkLocation(e.target.value)} />
                        </div>
                        <div className="form-label">
                        ...
                        <div className="form-label">
                            ...
                            <input type="text" className="form-control" value={cnss} onChange={(e) => setCnss(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Domaine d'étude :</label>
                            <input type="text" className="form-control" value={field_of_study} onChange={(e) => setFieldOfStudy(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Distance domicile-travail :</label>
                            <input type="text" className="form-control" value={home_work_distance} onChange={(e) => setHomeWorkDistance(e.target.value)} />
                        </div>
                        <div className="form-label">
                        ...
                        <div className="form-label">
                            ...
                            <input type="text" className="form-control" value={certificate_level} onChange={(e) => setCertificateLevel(e.target.value)} />
                        </div>
                    </div>
                    <div className="col-md-6">
                        ...
                        <div className="form-label">
                            ...
                            <input type="text" className="form-control" value={emergency_contact} onChange={(e) => setEmergencyContact(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Téléphone d'urgence :</label>
                            <input type="text" className="form-control" value={emergency_phone} onChange={(e) => setEmergencyPhone(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Numéro de compte bancaire :</label>
                            <input type="text" className="form-control" value={bank_account_number} onChange={(e) => setBankAccountNumber(e.target.value)} />
                        </div>
                        <div className="form-label">
                            <label className="form-label">Heures de travail :</label>
                            <input type="text" className="form-control" value={working_hours} onChange={(e) => setWorkingHours(e.target.value)} />
                        </div>
                        <div className="form-label">
