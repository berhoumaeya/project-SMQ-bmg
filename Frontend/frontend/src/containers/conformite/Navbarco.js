...
const Navbarco = ({ viewMode, setViewMode }) => {
    ...
    const getFormLink = () => {
        if (location.pathname.startsWith('/Allconformite')) {
            return '/AjouterConformite/';
        } else if (location.pathname.startsWith('/AllRisque')) {
            return '/AjouterRisk';
        } else {
            return '/FormProduit'; 
        }
