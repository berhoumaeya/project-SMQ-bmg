...
urlpatterns = [
    ...
    path('delete_not/<int:pk>/', DeleteNotificationView.as_view(), name='delete_not'),
    ...
    path('resTrait/', ResponsableTraitementListAPIView.as_view(), name='resTrait-list'),
    ...
    path('resTrait/<int:user_id>/', ResponsableTraitementDetailView.as_view(), name='resTrait-detail'),
